...
public class TopologyBasedCorrelationFT {
	...
	public static void main(String[] args) {
		...
		try {
			...
			resultOK = TestToolKit.testForTotalCount_NOT_CLEARED(4 /* expectedCount */);
			...
			if (resultOK) {
				...
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,WARNING,[Performance],isRoot=false,CausedBy=[server01::Unresponsive server03::Unresponsive server07::Unresponsive server02::Unresponsive server08::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
				...
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server08::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
			...
			if (resultOK) {
				...
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,WARNING,[Performance],isRoot=false,CausedBy=[server03::Unresponsive server09::Unresponsive server07::Unresponsive server02::Unresponsive server08::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server08::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server07::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
			...
			if (resultOK) {
				...
				expectedResults.clear();
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,MINOR,[Performance],isRoot=false,CausedBy=[server03::Unresponsive server09::Unresponsive server07::Unresponsive server02::Unresponsive server08::Unresponsive server10::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server08::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server07::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
			...
			if (resultOK) {
				...
				expectedResults.clear();
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,MAJOR,[HiAvailability],isRoot=false,CausedBy=[server01::Unresponsive server03::Unresponsive server09::Unresponsive server07::Unresponsive server02::Unresponsive server08::Unresponsive server10::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server08::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server07::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
			...
			if (resultOK) {
				...
				expectedResults.clear();
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,MINOR,[Performance],isRoot=false,CausedBy=[server01::Unresponsive server09::Unresponsive server07::Unresponsive server02::Unresponsive server08::Unresponsive server10::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server08::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server07::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
			...
			if (resultOK) {
				...
				expectedResults.clear();
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,MAJOR,[HiAvailability],isRoot=false,CausedBy=[server11::Unresponsive server01::Unresponsive server09::Unresponsive server07::Unresponsive server02::Unresponsive server08::Unresponsive server10::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server08::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server07::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
			...
			if (resultOK) {
				...
				expectedResults.clear();
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb::Impacted,MAJOR,[HiAvailability],isRoot=false,CausedBy=[MGTAWeb1::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[server03::Unresponsive server09::Unresponsive server02::Unresponsive server10::Unresponsive server07::Unresponsive server08::Unresponsive server11::Unresponsive server01::Unresponsive],Causes=[www.magenta.ca|MyProfile::Impacted MGTAWeb::Impacted],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::URL::www.magenta.ca|MyProfile::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[MGTAWeb1::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
			...
			if (resultOK) {
				expectedResults.clear();
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,MAJOR,[HiAvailability],isRoot=false,CausedBy=[server03::Unresponsive server09::Unresponsive server02::Unresponsive server10::Unresponsive server07::Unresponsive server11::Unresponsive server01::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
			...
			if (resultOK) {
				...
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,MAJOR,[HiAvailability],isRoot=false,CausedBy=[server03::Unresponsive server09::Unresponsive server02::Unresponsive server10::Unresponsive server07::Unresponsive server11::Unresponsive server01::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb2::Impacted,MINOR,[Performance],isRoot=false,CausedBy=[server04::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
			...
			if (resultOK) {
				...
				expectedResults.clear();
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb::Impacted,MAJOR,[HiAvailability],isRoot=false,CausedBy=[MGTAWeb2::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,MAJOR,[HiAvailability],isRoot=false,CausedBy=[server03::Unresponsive server09::Unresponsive server02::Unresponsive server10::Unresponsive server07::Unresponsive server11::Unresponsive server01::Unresponsive],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb2::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[server05::Unresponsive server04::Unresponsive server06::Unresponsive],Causes=[MGTAWeb::Impacted],AggregatedBy=[],Aggregates=[],[Losing resource]");
				...
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server04::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb2::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server05::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb2::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server06::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb2::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
				expectedResults
						.add("Smarts::MGTA-AM-PM:::Host::server07::Unresponsive,MAJOR,[Availability],isRoot=true,CausedBy=[],Causes=[MGTAWeb1::Impacted],AggregatedBy=[],Aggregates=[],[Unresponsive]");
			...
			if (resultOK) {
				...
				expectedResults.clear();
				expectedResults
						.add("CausalityAnalyser::local:::URL::www.magenta.ca|krr::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[MGTAWeb::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::URL::www.magenta.ca|home::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[MGTAWeb::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[MGTAWeb1::Impacted MGTAWeb2::Impacted],Causes=[www.magenta.ca|krr::Impacted www.magenta.ca|home::Impacted],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::URL::www.magenta.ca|MyProfile::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[MGTAWeb1::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[server03::Unresponsive server09::Unresponsive server02::Unresponsive server10::Unresponsive server07::Unresponsive server08::Unresponsive server11::Unresponsive server01::Unresponsive],Causes=[www.magenta.ca|MyProfile::Impacted MGTAWeb::Impacted],AggregatedBy=[],Aggregates=[],[Losing resource]");
			...
			if (resultOK) {
				...
				expectedResults.clear();
				expectedResults
						.add("Nimsoft::Nim01:::URL::www.magenta.ca|krr::NoAnswer,MAJOR,[Availability],isRoot=false,CausedBy=[www.magenta.ca|krr::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[NoAnswer]");
				expectedResults
						.add("Nimsoft::Nim01:::URL::www.magenta.ca|MyProfile::NoAnswer,MAJOR,[Availability],isRoot=false,CausedBy=[www.magenta.ca|MyProfile::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[NoAnswer]");
				expectedResults
						.add("Nimsoft::Nim01:::URL::www.magenta.ca|home::NoAnswer,MAJOR,[Availability],isRoot=false,CausedBy=[www.magenta.ca|home::Impacted],Causes=[],AggregatedBy=[],Aggregates=[],[NoAnswer]");

				expectedResults
						.add("CausalityAnalyser::local:::URL::www.magenta.ca|krr::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[MGTAWeb::Impacted],Causes=[www.magenta.ca|krr::NoAnswer],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::URL::www.magenta.ca|MyProfile::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[MGTAWeb1::Impacted],Causes=[www.magenta.ca|MyProfile::NoAnswer],AggregatedBy=[],Aggregates=[],[Losing resource]");
				expectedResults
						.add("CausalityAnalyser::local:::URL::www.magenta.ca|home::Impacted,CRITICAL,[Availability],isRoot=false,CausedBy=[MGTAWeb::Impacted],Causes=[www.magenta.ca|home::NoAnswer],AggregatedBy=[],Aggregates=[],[Losing resource]");
			...
			if (resultOK) {
				...
				linkKeyList.clear();
				linkKeyList.add("CausalityAnalyser::local:::URL::www.magenta.ca|krr::Impacted");
				linkKeyList.add("CausalityAnalyser::local:::URL::www.magenta.ca|MyProfile::Impacted");
				linkKeyList.add("CausalityAnalyser::local:::URL::www.magenta.ca|home::Impacted");

				linkKeyList.add("CausalityAnalyser::local:::Service::MGTAWeb::Impacted");
				linkKeyList.add("CausalityAnalyser::local:::Service::MGTAWeb1::Impacted");
				linkKeyList.add("CausalityAnalyser::local:::Service::MGTAWeb2::Impacted");
